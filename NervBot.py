...
async def aimer():
	...
	embed.add_field(name="Twitter Account", value="https://twitter.com/aimer_and_staff?lang=en")
	embed.add_field(name="SMEJ YouTube Channel", value="https://www.youtube.com/user/aimerSMEJ", inline=False)
	embed.add_field(name="VEVO YouTube Channel", value="https://www.youtube.com/user/AimerOfficialVEVO")
	embed.add_field(name="Reddit", value="https://www.reddit.com/r/Aimer/")
	embed.add_field(name="Spotify", value="https://open.spotify.com/artist/0bAsR2unSRpn6BQPEnNlZm")
	embed.add_field(name="Wikipedia", value="https://en.wikipedia.org/wiki/Aimer")
	embed.add_field(name="Last.fm", value="https://www.last.fm/music/Aimer")
	embed.add_field(name="Google+", value="https://plus.google.com/+aimer")
